...
To represent that \norm{\pa{\theta_3}x} is bounded above by 2, we write \(L_3=2\).
Likewise, \(L_0=1\), \(L_1=0\) and \(L_2=1\).

For the next parameter \(\theta_4=g_4(\theta_0,\theta_1,\theta_2,\theta_3)=\theta_3+\theta_1\theta_2\), we have
\begin{align*}
\norm{\pa{\theta_4}x}
&=\norm{\pa{\theta_4}{\theta_0}\pa{\theta_0}x+\pa{\theta_4}{\theta_1}\pa{\theta_1}x+\pa{\theta_4}{\theta_2}\pa{\theta_2}x
+\pa{\theta_4}{\theta_3}\pa{\theta_3}x}\\
&\le\norm{\pa{\theta_4}{\theta_0}}\norm{\pa{\theta_0}x}+\norm{\pa{\theta_4}{\theta_1}}\norm{\pa{\theta_1}x}+\norm{\pa{\theta_4}{\theta_2}}\norm{\pa{\theta_2}x}
+\norm{\pa{\theta_4}{\theta_3}}\norm{\pa{\theta_3}x}\\
&\le0\times1+\sup_x\left|\theta_2\right|\times0+\sup_x\left|\omega\right|\times1+1\times2\\
&=|\omega|+2
\end{align*}
Thus, \(L_4=|\omega|+2\).
...
\end{align*}
Thus, the Lipschitz constant for the function \(f_\omega\) is bounded above by \(|\omega|+\frac52\).
