...
If \(f:\mathbb R^n\to\mathbb R^m\) is Lipschitz continuous almost everywhere, it is possible to express the Lipschitz constant of \(f\) in its exact form, as the Rademacher Theorem suggests.
