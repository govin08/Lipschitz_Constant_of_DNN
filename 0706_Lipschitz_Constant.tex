...
In order to construct a systematic way to estimate the constant and to make use of automatic differentiation in implementing the backpropagation by Tensorflow or Pytorch, we think of a computation graph for \(f_\omega\).

\begin{figure}
\centering
\includegraphics[width=.8\textwidth]{computation_graph}
